...
import { ModuleContext, SearchingContext } from "./ModulePage";
...
import { isSatisfactoryCollection } from "../../utils/filter";
...
const ModuleCollection = ({ collection }) => {
  ...
  return (
    <>
      ...
      {collection && isSatisfactoryCollection(collection, query) && (
        <div
    ...
    border-charcoal hover:border-solid hover:border-regent-grey "
        >
          {useDelete.state.pending && (
            <LoadingAnimation message="Deleting..." />
          )}

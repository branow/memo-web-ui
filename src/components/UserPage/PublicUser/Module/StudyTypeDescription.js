...
const StudyTypeDescription = ({ collections, buttonsClassname }) => {
  return (
    <div className="w-full h-[8vh] flex flex-row p-[10px]">
      <div
        className={
          "peer/memo ml-[4vw] h-fit p-[5px] rounded-xl hover:bg-soft-green hover:text-main-green " +
          buttonsClassname
        }
      >
      ...
      <div
        className={
          "peer/write mx-[3vw] h-fit p-[5px] rounded-xl hover:bg-soft-green hover:text-main-green " +
          buttonsClassname
        }
      >

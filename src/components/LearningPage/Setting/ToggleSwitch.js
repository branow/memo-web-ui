const ToggleSwitch = ({ checked, onChangeAction, isSwitch }) => {
  return (
    <div className="w-fit">
      <label className="relative inline-flex items-center cursor-pointer">
        ...
        {isSwitch && (
          <div
            className="w-11 h-6 bg-orangy-yellow rounded-full peer dark:bg-gray-700 peer-focus:ring-4 peer-focus:ring-green-300 dark:peer-focus:ring-green-800 

      ...
      <Link to={exitDestination}>
        <div
          className="h-[100vh] w-[100vw] bg-glassy-grey
            fixed top-0 left-0 flex items-center justify-center z-20 opacity-100 pointer-events-auto duration-500 cursor-default"
        ></div>
      </Link>
      <div className="text-white fixed top-0 bottom-0 left-0 right-0 grid w-fit h-fit bg-dark-grey m-auto justify-center items-center overflow-hidden z-20 duration-500">
        <Link to={exitDestination}>
